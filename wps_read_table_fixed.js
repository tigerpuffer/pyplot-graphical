...
globalConfig.enableXAxis = true;
globalConfig.showGrid = true;
globalConfig.showLegend = true;
globalConfig.showValues = false;
globalConfig.titleCell = "";
globalConfig.xlabelCell = "";
globalConfig.ylabelCell = "";
globalConfig.xaxisCell = "";
...
function exportToJSON() {
    try {
        ...
        var datasets = [];
        var i;
        for (i = 0; i < globalConfig.datasets.length; i++) {
        ...
        config.chart_type = globalConfig.chartType;
        config.title = title;
        config.x_label = xlabel;
        config.y_label = ylabel;
        config.show_grid = globalConfig.showGrid;
        config.show_legend = globalConfig.showLegend;
        config.show_values = globalConfig.showValues;
...
function selectCell(prompt) {
    ...
    var selectedRange = Application.InputBox(prompt, "选择单元格", Type: 8);
